...
|-----|---------|------|
|Video|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/blob/master/README.md|
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others but nevertheless, here is a track record that everyone is contributing a lot)|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/pulse|
|Number of commits|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/graphs/contributors|
|Number of commits: by different people	|2|https://github.com/jayrshah98/GITS2.1-I.R.I.S/graphs/contributors|
|Issues reports: there are many	|2|https://github.com/jayrshah98/GITS2.1-I.R.I.S/issues|
|Issues are being closed	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/issues?q=is%3Aissue+is%3Aclosed|
|DOI badge: exists	|3|https://zenodo.org/badge/latestdoi/428784754|
|Docs: doco generated, format not ugly	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/tree/master/docs|
|Docs: what: point descriptions of each class/function (in isolation)|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/tree/master/docs|
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/tree/master/docs|
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/blob/master/README.md|
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/blob/master/README.md|
|Use of version control tools	|3|Used GIT which is a version control system|
|Use of style checkers	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/blob/master/.github/workflows/Style_Checker_and_Prettify_Code.yml|
|Use of code formatters.	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/blob/master/.github/workflows/code_formatter.yml|
|Use of syntax checkers.	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/blob/master/.github/workflows/syntax_checkers.yml|
|Use of code coverage	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/blob/master/.github/workflows/codecoverage.yml|
|Other automated analysis tools	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/tree/master/.github/workflows|
|Test cases exist	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/tree/master/test|
|Test cases are routinely executed	|0|Github actions doesnt have any runs|
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up	|3|https://github.com/jayrshah98/GITS2.1-I.R.I.S/blob/master/CONTRIBUTING.md|
|Issues are discussed before they are closed	|2|https://github.com/jayrshah98/GITS2.1-I.R.I.S/issues?q=is%3Aissue+is%3Aclosed|
|Chat channel: exists	|0||
|Test cases: a large proportion of the issues related to handling failing cases.	|2|https://github.com/jayrshah98/GITS2.1-I.R.I.S/issues|
|Evidence that the whole team is using the same tools: everyone can get to all tools and files	|3||
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)	|2|https://github.com/jayrshah98/GITS2.1-I.R.I.S/blob/master/requirements.txt|
...
|Does your website and documentation provide a clear, high-level overview of your software?|Yes|https://github.com/jayrshah98/GITS2.1-I.R.I.S/tree/master/docs|
|Does your website and documentation clearly describe the type of user who should use your software?|Yes|https://github.com/jayrshah98/GITS2.1-I.R.I.S/tree/master/README.md|
...
|Is your project/software name free from trademark violations?|Yes|https://github.com/jayrshah98/GITS2.1-I.R.I.S/blob/master/LICENSE|
...
|**Notes**|**Grading**|**Evidence**|
|-----|---------|------|
|Video|3|https://github.com/lokesh45/StockPrediction/blob/master/README.md|
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others but nevertheless, here is a track record that everyone is contributing a lot)|3|https://github.com/lokesh45/StockPrediction/pulse|
|Number of commits|3|https://github.com/lokesh45/StockPrediction/graphs/contributors|
|Number of commits: by different people	|3|https://github.com/lokesh45/StockPrediction/graphs/contributors|
|Issues reports	|3|https://github.com/lokesh45/StockPrediction/issues|
|Issues are being closed	|3|https://github.com/lokesh45/StockPrediction/issues?q=is%3Aissue+is%3Aclosed|
|DOI badge: exists	|3|https://zenodo.org/badge/latestdoi/301582156|
|Docs: doco generated, format not ugly	|3|https://github.com/lokesh45/StockPrediction/tree/master/doc|
|Docs: what: point descriptions of each class/function (in isolation)|3|https://github.com/lokesh45/StockPrediction/tree/master/doc|
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z	|3|https://github.com/lokesh45/StockPrediction/tree/master/doc|
...
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.|3|https://github.com/lokesh45/StockPrediction/blob/master/README.md|
|Use of version control tools	|3|Used GIT which is a version control system|
|Use of style checkers	|3|https://github.com/lokesh45/StockPrediction/blob/b70b625643cc6b51fdf10938ebfdda25d5a51aa5/Config.md?plain=1#L15|
|Use of code formatters.	|3|https://github.com/lokesh45/StockPrediction/blob/b70b625643cc6b51fdf10938ebfdda25d5a51aa5/Config.md?plain=1#L17C13-L17C13|
|Use of syntax checkers.	|3|https://github.com/lokesh45/StockPrediction/blob/b70b625643cc6b51fdf10938ebfdda25d5a51aa5/Config.md?plain=1#L15|
|Use of code coverage	|3|https://github.com/lokesh45/StockPrediction/blob/b70b625643cc6b51fdf10938ebfdda25d5a51aa5/Config.md?plain=1#L13|
|Other automated analysis tools	|3||
|Test cases exist	|3|https://github.com/lokesh45/StockPrediction/tree/master/tests|
|Test cases are routinely executed	|0|Github actions doesnt have any runs|
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up	|3|https://github.com/lokesh45/StockPrediction/blob/master/CONTRIBUTING.md|
|Issues are discussed before they are closed	|3|https://github.com/lokesh45/StockPrediction/issues?q=is%3Aissue+is%3Aclosed|
|Chat channel: exists	|3||
|Test cases: a large proportion of the issues related to handling failing cases.	|2|https://github.com/lokesh45/StockPrediction/issues|
|Evidence that the whole team is using the same tools: everyone can get to all tools and files	|3||
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)	|3|https://github.com/lokesh45/StockPrediction/blob/master/requirements.txt|
|Evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate the system running on their computer)	|3||
...
|Short release cycles	|2|https://github.com/lokesh45/StockPrediction/releases|
|Does your website and documentation provide a clear, high-level overview of your software?|Yes|https://github.com/lokesh45/StockPrediction/tree/master/doc|
|Does your website and documentation clearly describe the type of user who should use your software?|Yes|https://github.com/lokesh45/StockPrediction/blob/master/README.md|
|Do you publish case studies to show how your software has been used by yourself and others?|No||
|Is the name of your project/software unique?|Yes||
|Is your project/software name free from trademark violations?|Yes|https://github.com/lokesh45/StockPrediction/blob/master/LICENSE|
|Is your software available as a package that can be deployed without building it?|Yes||
|Is your software available for free?|Yes||
...
|Does your software list the web address, and licences for all third-party dependencies and say whether the dependencies are mandatory or optional?|No||
|Can you download dependencies using a dependency management tool or package manager? e.g. [Ivy](http://ant.apache.org/ivy/), [Maven](https://maven.apache.org/), [Python pip](https://pypi.python.org/pypi/pip) or [setuptools](https://pypi.python.org/pypi/setuptools), [PHP Composer](https://getcomposer.org/), [Ruby gems](https://rubygems.org), or [R PackRat](https://rstudio.github.io/packrat/)|Yes||
|Do you have tests that can be run after your software has been built or deployed to show whether the build or deployment has been successful?|Yes|https://github.com/lokesh45/StockPrediction/tree/master/tests|
|Do you have an automated test suite for your software?|Yes||
...
|Issues reports	|1|https://github.com/Pratyush1184/application-tracking-system/issues|
...
|If you provide more extensive documentation, does this provide clear, step-by-step instructions on how to deploy and use your software?|Yes||
|Do you provide a comprehensive guide to all your software’s commands, functions and options?|Yes|https://github.com/Pratyush1184/application-tracking-system|
