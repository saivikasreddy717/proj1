...
|Issues reports	|3|0 pending issues|
|Issues are being closed	|3|31 already closed|
|DOI badge: exists	|3|Yes|
|Docs: doco generated, format not ugly	|3||
|Docs: what: point descriptions of each class/function (in isolation)|3||
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z	|3||
...
|Other automated analysis tools	|3||
|Test cases exist	|3||
|Test cases are routinely executed	|3|Github actions doesnt have any runs|
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up	|3||
...
|Number of commits|3||
|Number of commits: by different people	|3||
|Issues reports	|1|14 pending issues|
|Issues are being closed	|1|5 already closed|
|DOI badge: exists	|3|Yes|
|Docs: doco generated, format not ugly	|3||
|Docs: what: point descriptions of each class/function (in isolation)|3||
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z	|3||
...
|Number of commits|3|Total commits are 127|
|Number of commits: by different people	|1|Prakriti and DEv did the most commits.|
|Issues reports: there are many	|2|4 pending issues|
|Issues are being closed	|3|12 already closed|
|DOI badge: exists	|3|Yes|
|Docs: doco generated, format not ugly	|3||
|Docs: what: point descriptions of each class/function (in isolation)|3||
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z	|3||
...
|Video|3||
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others but nevertheless, here is a track record that everyone is contributing a lot)|3||
|Number of commits|3|94 total commits|
|Number of commits: by different people	|3||
|Issues reports	|3|0 pending issues|
|Issues are being closed	|3|7 already closed|
|DOI badge: exists	|3||
|Docs: doco generated, format not ugly	|3||
|Docs: what: point descriptions of each class/function (in isolation)|3||
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z	|3||
